                    ...
                    if ($obj.val())
                    {
                         ...
                         for (var i = 0; i < tipuedrop_in.pages.length; i++)
                         {
                              ...
                              if ((tipuedrop_in.pages[i].title.search(pat) != -1) && c < set.show)
                              {
                                   ...
                                   out += '<div class="tipue_drop_item"><div class="tipue_drop_left"></div><div class="tipue_drop_right"><div class="tipue_drop_right_title">' + tipuedrop_in.pages[i].title + '</div></div></div>';
                                   c++;
                              }
                         }
                         if (c != 0)
